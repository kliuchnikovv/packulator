...
func TestPackagingService_NumberOfPackages(t *testing.T) {
	t.Run("successful calculation", func(t *testing.T) {
		...
		// Mock store response
		mockStore.On("GetPacksInvariantsByHash", ctx, versionHash).Return(invariants, nil)
...
func TestPackagingService_ContextHandling(t *testing.T) {
	...
	t.Run("cancelled context", func(t *testing.T) {
		...
		mockStore.On("GetPacksInvariantsByHash", ctx, versionHash).Return([]model.Pack{}, context.Canceled)
